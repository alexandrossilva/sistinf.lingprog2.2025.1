...
public class DuplaInsercaoConjuntoFuncionarios {
	...
	public static void main(String[] args) {
		...
		f4 = new Funcionario("José Silva", 7500, 1987, 12, 15); // dados de funcionário idênticos a f1
		...
		quadro.add(f4);						// inserção de 4º funcionário na tabela de hash
