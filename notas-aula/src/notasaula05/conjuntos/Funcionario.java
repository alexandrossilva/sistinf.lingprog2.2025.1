...
public class Funcionario {
	...
	// obtenção de código hash com base nos códigos hash de nome, salário e data de admissão
	public int hashCode() {
		return 7 * nome.hashCode() + 11 * Double.hashCode(salario) + 13 * dataAdmissao.hashCode();
	}
